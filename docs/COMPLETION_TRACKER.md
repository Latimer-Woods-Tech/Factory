# Completion Tracker
_Generated 2026-07-01T21:55:21+00:00 by `scripts/aggregate_completion.py`._
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|
| **HD** HumanDesign | 25 | 0 | 0 | 92 | 117 | 21.4% | 100.0% | **20.1%** (Δ+20.1) |
...
**Overall weighted pass: 10.9% (Δ+10.9)** · known: 100.0% · raw: 10.9%

### ↑ Top wins
- `HD-AUTH-002` (HD) — Sign In (weight 5) → ✅
- `HD-PROF-002` (HD) — My Blueprint Page (weight 4) → ✅
- `HD-CHART-006` (HD) — Today's Hint (weight 3) → ✅

## HD — HumanDesign
### Authentication & Authorization — 8.5% weighted (1✅ 0⚠️ 0❌ 11🔍)
...
### Profile & Blueprint — 14.3% weighted (1✅ 0⚠️ 0❌ 7🔍)
| ID | Feature | Status | W | Tags | Overlays |
|---|---|---|---:|---|---|
...
| ID | Feature | Status | W | Tags | Overlays |
|---|---|---|---:|---|---|
| `HD-PERF-001` | Homepage Load Time | 🔍 | 3 | — | auto-decay |
| `HD-PERF-002` | API Response Time | 🔍 | 3 | — | auto-decay |
| `HD-PERF-003` | Chart Generation | 🔍 | 4 | — | auto-decay |
| `HD-PERF-004` | Bundle Size | 🔍 | 3 | — | auto-decay |
...
### Practitioner Arsenal — 93.1% weighted (14✅ 0⚠️ 0❌ 1🔍)
| ID | Feature | Status | W | Tags | Overlays |
|---|---|---|---:|---|---|
| `HD-ARS-001` | Deliver — curate & dispatch | ✅ | 4 | — | — |
| `HD-ARS-002` | Council of Essence synthesis | ✅ | 4 | — | — |
| `HD-ARS-003` | Sky reading deliverable | ✅ | 4 | — | — |
| `HD-ARS-004` | Best timing (client-scoped) | ✅ | 4 | — | — |
| `HD-ARS-005` | Clusters — group charts | 🔍 | 4 | — | — |
| `HD-ARS-006` | Cohort insights | ✅ | 3 | — | — |
| `HD-ARS-007` | Warm-lead inquiries | ✅ | 4 | — | — |
| `HD-ARS-008` | Divination readings | ✅ | 4 | — | — |
| `HD-ARS-009` | Blessed access | ✅ | 4 | — | — |
| `HD-ARS-010` | Quick Prep (solo adoption) | ✅ | 3 | — | — |
| `HD-ARS-011` | Practitioner branding | ✅ | 3 | — | — |
| `HD-ARS-012` | Stripe Connect + native booking | ✅ | 5 | — | — |
| `HD-ARS-013` | Referral revenue share | ✅ | 4 | — | — |
| `HD-ARS-014` | Session briefs / prep | ✅ | 4 | — | — |
| `HD-ARS-015` | Client management | ✅ | 4 | — | — |

### Learning Construct — 100.0% weighted (2✅ 0⚠️ 0❌ 0🔍)
| ID | Feature | Status | W | Tags | Overlays |
|---|---|---|---:|---|---|
| `HD-LEARN-001` | Learning Hub | ✅ | 3 | — | — |
| `HD-LEARN-002` | Practice Lab | ✅ | 3 | — | — |

### Guided-Client Shell — 84.2% weighted (6✅ 0⚠️ 0❌ 1🔍)
| ID | Feature | Status | W | Tags | Overlays |
|---|---|---|---:|---|---|
| `HD-GC-001` | GC Home | ✅ | 3 | — | — |
| `HD-GC-002` | GC Blueprint | ✅ | 3 | — | — |
| `HD-GC-003` | GC Session | ✅ | 3 | — | — |
| `HD-GC-004` | GC Today | ✅ | 3 | — | — |
| `HD-GC-005` | GC Support | ✅ | 2 | — | — |
| `HD-GC-006` | GC Live Session | 🔍 | 3 | — | — |
| `HD-GC-007` | GC Learning | ✅ | 2 | — | — |
...
| ID | Feature | Status | W | Tags | Overlays |
|---|---|---|---:|---|---|
| `FA-CAT-001` | Public manifest | 🔍 | 2 | — | auto-decay |
| `FA-CAT-002` | Function catalog | 🔍 | 2 | — | auto-decay |
| `FA-CAT-003` | App registry | 🔍 | 2 | — | auto-decay |
| `FA-CAT-004` | Apps list | 🔍 | 2 | — | auto-decay |

### Test Runs & Deploys (CI/CD surface) — 0.0% weighted (0✅ 0⚠️ 0❌ 8🔍)
| ID | Feature | Status | W | Tags | Overlays |
|---|---|---|---:|---|---|
| `FA-CICD-001` | Test runs API | 🔍 | 2 | — | auto-decay |
| `FA-CICD-002` | Deploys API | 🔍 | 5 | — | auto-decay |
| `FA-CICD-003` | GitHub dispatch | 🔍 | 2 | — | auto-decay |
| `FA-CICD-004` | GitHub API wrapper | 🔍 | 2 | — | auto-decay |
| `FA-CICD-005` | Repo API | 🔍 | 2 | — | auto-decay |
| `FA-CICD-006` | Studio tests webhook | 🔍 | 5 | — | auto-decay |
| `FA-CICD-007` | Deployment verification script | 🔍 | 2 | — | auto-decay |
| `FA-CICD-008` | Service registry check script | 🔍 | 2 | — | auto-decay |

### AI Analysis & Audit Trail — 0.0% weighted (0✅ 0⚠️ 0❌ 4🔍)
| ID | Feature | Status | W | Tags | Overlays |
|---|---|---|---:|---|---|
| `FA-AI-001` | AI routes | 🔍 | 2 | — | auto-decay |
| `FA-AI-002` | AI analysis cycle (cron) | 🔍 | 2 | — | auto-decay |
| `FA-AI-003` | Audit log API | 🔍 | 5 | — | auto-decay |
| `FA-AI-004` | Timeline API | 🔍 | 2 | — | auto-decay |

### Observability, SLO & Ops — 0.0% weighted (0✅ 0⚠️ 0❌ 6🔍)
| ID | Feature | Status | W | Tags | Overlays |
|---|---|---|---:|---|---|
| `FA-OBS-001` | Observability API | 🔍 | 2 | — | auto-decay |
| `FA-OBS-002` | SLO API | 🔍 | 2 | — | auto-decay |
| `FA-OBS-003` | Schema readiness | 🔍 | 2 | — | auto-decay |
| `FA-OBS-004` | Smoke tests API | 🔍 | 2 | — | auto-decay |
...
| ID | Feature | Status | W | Tags | Overlays |
|---|---|---|---:|---|---|
| `FA-FLG-001` | Flagship / feature flags | 🔍 | 2 | — | auto-decay |
| `FA-FLG-002` | Data Subject Requests | 🔍 | 5 | — | auto-decay |
| `FA-FLG-003` | Digest orchestrator | 🔍 | 2 | — | auto-decay |
| `FA-FLG-004` | Digest collect | 🔍 | 2 | — | auto-decay |
| `FA-FLG-005` | Digest render | 🔍 | 2 | — | auto-decay |
| `FA-FLG-006` | Digest audio (TTS) | 🔍 | 2 | — | auto-decay |
