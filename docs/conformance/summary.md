...
*Generated: 2026-06-29 (UTC). Stage 1 shadow — scores are advisory, not enforced.*
...
- ✅ Migrations directory present
- ✅ ROLLBACK block enforced — WARN: 2 existing migration(s) missing -- ROLLBACK: block (debt — not blocking): migrations/0100_studio_entitlements.sql, migrations/0120_stripe_connect_accounts.sql
- ✅ Numbered file naming
