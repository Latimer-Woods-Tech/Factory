...
*Last updated: 2026-06-03 (auto-update: see `.github/workflows/update-stack-manifest.yml`)*
...
| `@latimer-woods-tech/llm` | `0.4.0` | stable |
| `@latimer-woods-tech/llm-meter` | `0.2.3` | stable |
