...
export function Dashboard() {
  ...
  return (
    <div className="flex h-[calc(100dvh-44px)] overflow-hidden pt-safe-top md:pt-0">
      ...
      {/* Main content — pad bottom on mobile for safe-area (notched/gesture devices) */}
      <main className="relative flex-1 overflow-auto p-4 pb-[calc(env(safe-area-inset-bottom)+4rem)] md:p-6 md:pb-6">
