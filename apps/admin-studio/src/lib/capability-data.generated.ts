// AUTO-GENERATED by scripts/capabilities/compile.mjs — do not edit by hand.
// Generated: 2026-05-24T20:32:13Z
export const capabilityData = {
  "generatedAt": "2026-05-24T20:32:13Z",
  "primitives": [
    {
      "contracts": {
        "policyTags": [
...
export type CapabilityData = typeof capabilityData;
export type Primitive = typeof capabilityData.primitives[number];
export type Recipe = typeof capabilityData.recipes[number];
export type Concept = typeof capabilityData.concepts[number];
export type Rule = typeof capabilityData.rules[number];
