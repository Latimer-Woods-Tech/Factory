...
| Smoke/quality | `smoke-prime-self.yml`, `studio-test-dispatch.yml`, `doc-freshness-audit.yml`, `docs-health.yml`, `_docs-health.yml` | Validate live app/ops surfaces, docs freshness, docs catalog health, and documentation drift | Failures create dashboard work items, not ad hoc root summaries |
