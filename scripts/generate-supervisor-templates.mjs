...
// (slot_names, slot_validators, slot_defaults, step_intents, pr_files are not part of the Worker Template type)
const workerTemplates = templates.map(({ slot_names, slot_validators, slot_defaults, step_intents, pr_files, ...t }) => t);
